...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage:{
        circularLight: 'repeating-radial-gradient(rgba(0,0,0,0.4) 2px, #f5f5f5 3px, #f5f5f5 100px);',
        ...
        circularLightMd: "repeating-radial-gradient(rgba(0,0,0,0.4) 2px,#f5f5f5 3px,#f5f5f5 60px)",
        circularDarkMd: "repeating-radial-gradient(rgba(255,255,255,0.5) 2px,#1b1b1b 4px,#1b1b1b 60px)",
        circularLightSm:  "repeating-radial-gradient(rgba(0,0,0,0.4) 2px,#f5f5f5 3px,#f5f5f5 40px)",
