      ...
      <main className='flex flex-col items-center text-dark w-full min-h-screen dark:text-light'>
        <Layout className='pt-0'>
          <div className='flex items-center justify-between w-full'>
            <div className='w-1/2'><Image src={profilePic} alt='milkiasTonjiPic' /></div>
              ...
              <p className='my-4 text-base font-medium'>As a skilled full-stack developer, I am dedicated to turning ideas into innovative web applications.
                ...
                <div className='flex items-center self-start mt-2'>
                  ...
                  className='flex items-center text-dark ml-3 p-2.5 px-6 rounded-lg text-lg font-semibold hover:bg-dark
                   hover:text-light border border-solid border-dark dark:text-light dark:border-light hover:dark:bg-light hover:dark:text-dark'
                  >Contact Me</Link>
                </div>
            </div>
          </div>
