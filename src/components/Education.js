...
const Details = ({type, time, place, info}) => {
    ...
    return <li ref={ref} className='my-8 first:mt-0 last:mb-0 w-[60%] mx-auto flex flex-col items-center justify-center md:w-[80%]'>
        ...
        >
            <h3 className='capitalize font-medium text-2xl dark:text-light sm:text-xl xs:text-lg'>{type}</h3>
...
const Education = () => {
  ...
  return (
    <div className='my-40'>
        <h2 className='font-bold text-6xl mb-32 w-full text-center dark:text-light md:text-6xl xs:text-4xl md:mb-16'>Education</h2>
        <div className='w-[75%] mx-auto relative lg:w-[90%] md:w-full'>
            <motion.div
            style={{scaleY: scrollYProgress}}
            ref={ref} className='absolute left-9 top-0 w-[4px] h-full bg-dark origin-top dark:bg-light
