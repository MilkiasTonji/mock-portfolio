...
const Details = ({type, time, place, info}) => {
    ...
    return <li ref={ref} className='my-8 first:mt-0 last:mb-0 w-[60%] mx-auto flex flex-col items-center justify-center'>
        ...
        >
            <h3 className='capitalize font-medium text-2xl dark:text-light'>{type}</h3>
...
const Education = () => {
  ...
  return (
    <div className='my-40'>
        <h2 className='font-bold text-6xl mb-32 w-full text-center dark:text-light'>Education</h2>
