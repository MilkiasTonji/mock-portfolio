...
const Skill = ({ name, x, y }) => {
  return (
    ...
    py-3 px-6 shadow-dark cursor-pointer absolute dark:bg-light dark:border-dark dark:border dark:text-dark'
...
const Skills = () => {
  return (
    <>
      <h2 className='font-bold text-8xl mt-40 w-full text-center dark:text-light'>Skills</h2>
      <div className='w-full h-screen relative flex items-center justify-center rounded-full bg-circularLight dark:bg-circularDark'>

        <motion.div className='flex items-center justify-center rounded-full font-semibold bg-dark dark:bg-light/75 dark:text-dark text-light p-8 shadow-dark cursor-pointer'
          whileHover={{ scale: 1.05 }}
        >
          WEB
        </motion.div>
